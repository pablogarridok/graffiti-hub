-- schema.sql - Base de datos GraffitiHub (fusionado con campos de administración)

-- Usar la base de datos configurada en Docker
USE blog_db;
...
INSERT INTO users (
    ...
    'admin',
    'active',
    'Administrador del sistema GraffitiHub',
    'Madrid',
    NOW()
)
ON DUPLICATE KEY UPDATE role = 'admin';

-- Nota: la contraseña del admin es "password123"
